class Question
  ...
  def run_test(questions)
    ...
    questions.each_with_index do |(quiz, _), index|
      puts "#{index + 1}. #{quiz} Quiz"
    end
    quiz_choice = gets.chomp.to_i
  
    # Accessing quiz questions
    selected_quiz = questions.keys[quiz_choice - 1]
    selected_questions = questions[selected_quiz]
    ...
    puts "\nQuiz complete! Your score: #{score} out of #{selected_questions.length}\n\n"
  end
